...
var SIWCAdmin;!function(e){var t=Core.Admin.Components.MediaSelector,i=Core.Admin.Components.StepTracker,n=function(){function n(n){var r=this;this.home=n,jQuery.views.settings.allowCode(!0),setInterval(function(){var e=n.find(".loader-indicator");e.html("•••"===e.html()?"":e.html()+"•")},155),jQuery.tips({action:"click",element:".tooltip"});var a=new i(n.find(".step-tracker-wrapper#add-image")),c=new e.Controllers.DrawBoard(n),o=new e.Controllers.Lister(n);new t(n.find(".btn-select-image"),function(e){r.activeImage=e.url,r.activeThumb=e.sizes&&e.sizes.thumbnail?e.sizes.thumbnail.url:e.url,n.find(".selected-img-holder img").attr("src",r.activeImage),c.setDrawBoard(),r.mode="create",a.next()});Core.Admin.Dispatcher.subscribe("image:edit",function(t){function i(){this.mode="edit",c.setDrawBoard(),c.setTags(o),a.setStep(2),Core.Admin.Dispatcher.publish("tab:activate","options-addimage")}var o=[];n.find(".selected-img-holder img").attr("src",t.image),r.activeImage=t.id;var d=[];if(t.tags.forEach(function(e,t){e.id&&d.push(e.id)}),d.length){var s=[];e.Api.Product.getProductsByIds(d).then(function(e){s=e}).then(function(){t.tags.forEach(function(t,i){var n=new e.Models.Tag;if(n.percentageX=t.x,n.percentageY=t.y,n.product=new e.Models.Product(t.id,t.name,t.price),t.id){var r=e.Helpers.Collections.findBy(s,"id",t.id);r&&(n.product.url=r.url,n.product.name=r.name,n.product.price=r.price,o.push(n))}else o.push(n)}),i()})}else o=t.tags,t.tags.forEach(function(t){var i=new e.Models.Tag;i.percentageX=t.x,i.percentageY=t.y,i.product=new e.Models.Product(null,t.name,t.price),t.url&&(i.product.url=t.url),o.push(i)}),i()}),n.find(".btn-start-over").on("click",function(e){e.preventDefault(),c.setDrawBoard(),a.setStep(1),r.activeImage=null}),n.find(".btn-save-image").on("click",function(t){t.preventDefault();var i=(jQuery(t.currentTarget),[]);c.getTags().forEach(function(e){if(e.product){var t={x:e.percentageX,y:e.percentageY,id:e.product.id};e.product.id||(t.price=e.product.price,t.name=e.product.name,t.url=e.product.url),i.push(t)}});var n=function(e){o.displayImages(1),r.home.find(".active-shortcode").html('[shoppable_image id="'+e+'"]'),a.next()};"create"===r.mode?e.Api.Images.addImage(r.activeImage,r.activeThumb,i).then(function(e){n(e)}):e.Api.Images.updateImage(r.activeImage,i).then(function(){n(r.activeImage)})}),Core.Admin.Dispatcher.subscribe("settings:changed",function(e){c.draw(e)}),Core.Admin.Dispatcher.subscribe("tab:changed",function(e){"options-addimage"===e&&c.draw()})}return n}();e.Main=n}(SIWCAdmin||(SIWCAdmin={})),jQuery(document).ready(function(){new SIWCAdmin.Main(jQuery(document.body))});
